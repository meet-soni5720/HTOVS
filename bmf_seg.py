...
input_video_path = "/home/pamin/bmf_seg/person_face.mp4"
output_video_path = "./blurred_op.mp4"
...
input_prompt = "human face. "
graph = bmf.graph()

person_face_blur = bmf.create_module('person_face_blur', {
...
mask_stream = video_stream['video'].module('person_face_blur',
                                            pre_module=person_face_blur, scheduler=5)
